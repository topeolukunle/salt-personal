...
def handle_create_asset(event, username, groups):
    ...
    location = {
    	...
    	'building': body.get('building') or 'NOT-SET',
    	'floor': body.get('floor') or 'NOT-SET',
    	'room': body.get('room') or 'NOT-SET',
    	'assigned_to': body.get('assigned_to') or 'NOT-SET',
    	'assigned_user_id': body.get('assigned_user_id') or 'NOT-SET',
    	'assigned_department': body.get('assigned_department') or 'NOT-SET',
    	'condition': body.get('condition') or 'Good',
